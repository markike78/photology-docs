...
A Lightroom Classic plugin that uses AI vision models to generate metadata for your photos, and syncs that metadata across folder stacks.
...
- Internet access for AI tagging (Sync Stack Metadata works entirely offline)
